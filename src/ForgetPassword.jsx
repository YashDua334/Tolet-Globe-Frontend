...
import { FaUser, FaLock, FaRegAddressCard,FaSchool, FaPhoneAlt  } from 'react-icons/fa';
...
const ForgetPassword = () => {
  ...
  <div className="absolute bg-black rounded-[50px_5px] inset-1 p-[50px_40px] z-10 text-white">
    ...
    <AiOutlineMail className="ml-3 text-white " />
      ...
      placeholder="Email"  autoComplete="off" id="exampleInputEmail1"
                value={email}
    ...
    <FaSchool  className="ml-3 text-white" />
      <input type="text"  
       className="w-full h-8 bg-transparent border-b border-white text-white placeholder:text-[#3CBDB1] placeholder:text-sm placeholder:tracking-wider pl-2 text-lg outline-none"
       placeholder="Your first School"  autoComplete="off" id="exampleInputEmail1"
                value={answer}
    ...
    <FaLock className="ml-3 text-white" />
      <input type="password"  
       className="w-full h-8 bg-transparent border-b border-white text-white placeholder:text-[#3CBDB1] placeholder:text-sm placeholder:tracking-wider pl-2 text-lg outline-none"
       placeholder="Password"  autoComplete="off" value={newPassword}
    ...
    <div className="relative w-[300px] h-[40px] mt-[70px] transition-all duration-1000" >
      <button type="submit"
      className='"absolute w-full h-full text-xl tracking-wider border border-[#C8A217] rounded-full bg-black flex items-center justify-center text-white hover:bg-[#C8A217]"'>RESET</button>
    </div>
  </div>
</div>
        </form>
